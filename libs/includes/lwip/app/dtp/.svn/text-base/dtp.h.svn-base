...
void *dtp_cli_reg(struct sockaddr_in *dest_addr, int (*cb_func)(void *hdl, enum dtp_cli_msg_type type, u8 *buf, u32 len, void* priv),  void *priv, int dtp_mode);
void dtp_cli_unreg(void *hdl);
int dtp_cli_send(void *hdl);
int dtp_cli_send_buf(void *hdl, u8 *buf, u32 len, int flag);
...
int dtp_cli_recv(void *handle, u8 *buf, u32 len, int flag);
...
int dtp_srv_send_buf(void *cli, u8 *buf, u32 len, int flag);
int dtp_srv_recv(void *cli, u8 *buf, u32 len, int flag);
