...
const struct MapperTable_tag MapperTable[] =
{
  ...
  {   3, Map3_Init   },
  {   4, Map4_Init   },
 //{   5, Map5_Init   },  /*屏蔽掉的Map,是因为它占用RAM太大*/
 // {   6, Map6_Init   }, /*屏蔽掉的Map,是因为它占用RAM太大*/
  {   7, Map7_Init   },
  {   8, Map8_Init   },
  {   9, Map9_Init   },
  {  10, Map10_Init  },
  ...
  {  17, Map17_Init  },
  {  18, Map18_Init  },
//  {  19, Map19_Init  }, /*屏蔽掉的Map,是因为它占用RAM太大*/
  {  21, Map21_Init  },
  {  22, Map22_Init  },
  {  23, Map23_Init  },
  {  24, Map24_Init  },
  ...
  {  43, Map43_Init  },
  {  44, Map44_Init  },
//  {  45, Map45_Init  }, /*屏蔽掉的Map,是因为它占用RAM太大*/
  {  46, Map46_Init  },
  {  47, Map47_Init  },
  {  48, Map48_Init  },
  {  49, Map49_Init  },
  ...
  {  82, Map82_Init  }, 
  {  83, Map83_Init  },
//  {  85, Map85_Init  }, /*屏蔽掉的Map,是因为它占用RAM太大*/
  {  86, Map86_Init  },
  {  87, Map87_Init  },
  {  88, Map88_Init  },
  {  89, Map89_Init  },
